        ...
        <div className='grid lg:grid-cols-3 gap-8 items-start py-20 md:py-28'>
          <div className='lg:col-span-2 flex flex-col gap-6'>
            <div className='flex items-center gap-5'>
              <div className={classNames('block aspect-square font-semibold text-3xl text-navy w-[54px] lg:w-[70px] text-center flex flex-shrink-0 items-center justify-center', colours[colour])}>
                <PackageIcon icon={icon} className='p-3 lg:p-4' />
              </div>
              <div>
